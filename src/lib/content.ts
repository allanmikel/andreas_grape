...
export const content = {
  ...
  hero: {
    ...
    ctas: [
      { label: 'Nordic Angels', href: '#' },
      { label: 'Angel House',   href: '#' },
    ],
  },
  ...
  nordicAngelsOverview: {
    ...
    link: { label: 'Visit Nordic Angels', href: '#' },
  },
  ...
  portfolio: {
    ...
    cases: [
      ...
      { slug: 'state-of-european-angels', kind: 'initiative', name: 'State of European Angels',
        built: 'Placeholder — to be added.',
        subtitle: 'The annual report.',
        description: 'Placeholder description — copy to be added.',
        year: '2024 →', status: 'Active',
